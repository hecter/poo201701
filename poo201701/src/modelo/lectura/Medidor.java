...
public class Medidor {
    ...
    public Medidor(BigDecimal id, Casas casas, String serial, BigDecimal costo) {
        this.id = id;
        this.casas = casas;
        this.serial = serial;
        this.costo = costo;
    ...
    public int insertar() throws SQLException{
        ...
        basededatos.asignarParametro(3, new BigDecimal(nextVal("SECTORES_SEQ")));
        basededatos.asignarParametro(4, getDet());
